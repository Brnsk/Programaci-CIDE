...
import pru04e05_rubriques.PRU04E05Parking_Pablo_Florit;
import pru04e05_rubriques.TipusPlacesParking;
...
public class parkingTest {
	...
	public static void respostaMenu(int choice) {
		...
		break;
		case 7: places = parking.getPlacesLliures(tipus.No_Discapacitat);
		System.out.println("Places normals lliures = "+places);
		break;
		case 8: places = parking.getPlacesOcupades(tipus.No_Discapacitat);
		System.out.println("Places normals ocupades = "+places);
		break;
		case 9: places = parking.getPlacesLliures(tipus.Discapacitat);
		System.out.println("Places per a discapacitats lliures = "+places);
		break;
		case 10: places = parking.getPlacesOcupades(tipus.Discapacitat);
	...
	static PRU04E05Parking_Pablo_Florit parking;
	...
	public static void main(String[] args) {
		parking = new PRU04E05Parking_Pablo_Florit(PLACES_NORMALS,PLACES_DISCAPACITATS);
